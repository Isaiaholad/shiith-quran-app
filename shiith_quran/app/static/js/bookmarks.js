...
function waitForAuthAndLoadBookmarks() {
    document.addEventListener('auth:ready', initBookmarksPage, { once: true });
}

if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', waitForAuthAndLoadBookmarks);
} else {
    waitForAuthAndLoadBookmarks();
}
